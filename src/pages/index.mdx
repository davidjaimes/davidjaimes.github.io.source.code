...
<Card className="shadow mt-5 mb-5 bg-light">
  <Card.Body>
    <Card.Title>
      <Button src="https://www.python.org/" variant="outline-primary stretched-link">Python</Button> <small className="text-muted">https://www.python.org/</small></Card.Title>
    <Card.Text>
...
<Card className="shadow mt-5 mb-5 bg-light">
  <Card.Body>
    <Card.Title>
    <Button src="https://docs.conda.io/en/latest/miniconda.html" variant="outline-primary stretched-link">Miniconda</Button> <small className="text-muted">https://docs.conda.io/en/latest/miniconda.html</small></Card.Title>
    <Card.Text>
...
<Card className="shadow mt-5 mb-5 bg-light">
  <Card.Body>
    <Card.Title>
    <Button src="https://www.sublimetext.com/" variant="outline-primary stretched-link">Sublime Text</Button> <small className="text-muted">https://www.sublimetext.com/</small></Card.Title>
    <Card.Text>
