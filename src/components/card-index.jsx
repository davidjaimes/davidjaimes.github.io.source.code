		...
		<div>
			<Card className="mt-5 mb-5 border border-dark">
				<Card.Body>
					...
					<Card.Text>
					<small><b>Kepler-16b</b> (formally <b>Kepler-16 (AB)-b</b>) is an extrasolar planet. It is a Saturn-mass planet consisting of half gas and half rock and ice, and it orbits a binary star, Kepler-16, with a period of 229 days. "It is the first confirmed, unambiguous example of a circumbinary planet – a planet orbiting not one, but two stars," said Josh Carter of the Harvard-Smithsonian Center for Astrophysics, one of the discovery team.</small>
					</Card.Text>
				</Card.Body>
			</Card>
